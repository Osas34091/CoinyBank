    ...
    <div className="min-h-screen bg-slate-50 p-6 md:p-12 font-sans pb-32">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 text-center">
          <div className="w-20 h-20 bg-green-100 text-green-700 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Landmark className="w-10 h-10" />
          </div>
          <h2 className="text-3xl font-black text-slate-800 mb-4">{t("myLoans")}</h2>
